...
"""
This module defines a function that takes a string and a number,
squares the number,
and returns a tuple containing the string and the squared number.

The function handles both integers and floats as the input for the number,
and ensures that the result is returned as a float.
"""
...
def to_kv(k: str, v: Union[int, float]) -> Tuple[str, float]:
    ...
    and a number `v` (which can be an integer or a float),
    squares the number,
