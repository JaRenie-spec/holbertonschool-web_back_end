...
"""
This module provides a function to calculate the floor value
of a given floating-point number.

It uses the math.floor() function to return the largest integer
...
def floor(n: float) -> int:
    ...
    This function uses the math.floor() method
    to return the floor of the input float.
