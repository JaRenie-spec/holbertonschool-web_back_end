...
It defines a function that takes a list containing both integers and floats,
...
def sum_mixed_list(mxd_lst: List[Union[int, float]]) -> float:
    ...
    calculates the total sum of the elements in the list,
    and returns the sum as a float.

    Parameters:
        mxd_lst (List[Union[int, float]]): A list of integers
        and/or floats to be summed.
